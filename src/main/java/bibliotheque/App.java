...
public class App extends Application {
	...
	/*
	 * Document document = new Document(); document.append("login", com.getLogin()
	 * ); document.append("datePublication", com.getDatePublication());
	 * document.append("note", com.getNote()); document.append("texte",
	 * com.getTexte());
	 * 
	...
	// Commentaire com = new Commentaire("Oeuvre", "loginFZ58", "2011-03-16", 9.4,
	// "blabla");
	...
	// ArrayList<FormationUtilisateur>();
	// formation1.add(new FormationUtilisateur("MasterMIAGE",2019,2021));
	// Utilisateur user = new Utilisateur("Pierrat", "Charly",
	// universiteRattachement, formation1, Role.Etudiant);
