...
>>>>>>> branch 'master' of https://github.com/flozhm/M1-Struct-doc-bibliotheque.git
	...
	/*
	 * ArrayList<String> universiteRattachement = new ArrayList<String>();
	 * universiteRattachement.add("IDMC"); universiteRattachement.add("DME");
	 ...
	 * Utilisateur("Pierrat", "Charly", universiteRattachement, formation1,
	 * Role.Etudiant); MAJBase.insererUtilisateurEnBase(user);
	 */
